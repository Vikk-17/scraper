...
class DatabaseConnection:
    ...
    def __init__(self):
        ...
        try:
            self.mongo_client = MongoClient(
                "mongodb+srv://test:test123@cluster0.xqrer.mongodb.net/"
            )
    ...
    def process_and_store_payload(self, payload: dict):
        try:
            user_id = payload.get("userId") # get user id
            user_email = payload.get("email") # get email
            scan_data = payload.get("scanData") # get scan data
            ...
            for scan_entry in scan_data:
                ...
                for productName, productId in products.items():
                    # removing the product id because getting it from backend
                    # product_id = sha256(f"{product}_{user_id}".encode()).hexdigest()
                    product_id = productId

                    # Fetch existing product document
                    existing_product = self.user_products_collection.find_one(
                        {"_id": product_id}
                    )
                    ...
                    product_data = {
                        ...
                        "product_name": productName,    ### added new code
...
class ScraperManager:
    def __init__(
        self,
        db_uri="mongodb+srv://test:test123@cluster0.xqrer.mongodb.net/",
        db_name="monitor_scan",
    ):
...
class VendorScraperManager:
    def __init__(self):
        self.vendor_scrapers = {
            ...
            "Schneider Electric": SchneiderScraper,
        }
...
async def main():
    payload = {
        ...
        "scanData": [
            {
                "vendor": "Dell",
                "vendorWebsite": "https://www.dell.com",
                "products": ["Product AB", "one", "two"],
            },
            {
                "vendor": "Siemens",
                "vendorWebsite": "https://www.siemens.com",
                "products": ["Product f"],
            },
            {
                "vendor": "GE",
                "vendorWebsite": "https://www.ge.com",
                "products": ["Product 9", "Product 5100"],
            },
            {
                "vendor": "HP",
                "vendorWebsite": "https://www.hp.com",
                "products": ["hp something"],
            },
        ],
    }
    ...
    payload2 = {
        ...
        "scanData": [
            ...
            {
                "vendor": "NVIDIA",
                "vendorWebsite": "https://www.nvidia.com",
                "products": ["NeMo"],
            },
        ],
    }
        ...
        "scanData": [
            {
                "vendor": "Dell",
                "vendorWebsite": "https://www.dell.com",
                "products": {"product name1": "pid1", "product name2": "pid2"},
            },
            {
                "vendor": "NVIDIA",
                "vendorWebsite": "https://www.nvidia.com",
                "products": ["NeMo", "ChatRTX", "GPU display driver"],
            },
        ],
    }
        ...
        "scanData": [
            {
                "vendor": "NVIDIA",
                "products": {
                    "ChatRTX": "e6af77c6-1b43-4ab1-a403-f928c76b9a08",
                    "NeMo": "eedf45a3-7eab-4a9f-b000-67c82883b186",
                },
            },
            {
                "vendor": "Schneider Electric",
                "products": {"Harmony HMI and Pro-face HMI products": "eda402e7-1d07-4e45-ab8f-3a1bc636dfe7"},
            },
        ],
    }
    ...
    db.process_and_store_payload(payload=payload4)

    print("Database connection done successfully")

    sp = ScraperManager()

    data = await sp.fetch_user_products(["6752b04e67108c31580d4b53"])
